...
public class ArticleFileController {
    ...
    public ResponseEntity<String> uploadFile(MultipartFile file) throws Exception {
        ...
        log.info("CONTENT TYPE : " + file.getContenType());
        log.info("=============================================================");
    ...
    public ResponseEntity<byte[]> displayFile(String fileName) throws Exception {
        ...
        try {
            ...
            if(mediaType != null) {
                ...
                // 다운로드 MINEType 지정
                httpHeaders.setContentType(MediaType.APPLICATION_CONTENT_STREAM);

                // 한글 이름의 팡리 인코딩 처리
                httpHeaders.add("Content-Disposition", "attachment; filename=\"" + 
                            
                    new String(fileName.getBytes("UTF-8"), "ISO-8859") + "\"");

            }
            entity = new ResponseEntity<byte[]>(IOUils.toByteArray(inputStream),httpHeaders, HttpStatus.CREATED);
